...
data class AdInfoModel(
    ...
    // 精準投放
    @Json(name = "precise_target_audience") var preciseTargetAudience: PreciseTargetAudienceModel? = null,
    // 目標客群
    @Json(name = "target_audience") var targetAudience: TargetAudienceModel? = null,
    ...
    @Json(name = "live_front_cover") var liveFrontCover: LiveFrontCoverModel? = null,
    @Json(name = "live_hash_tag") var hashTagList: List<String>? = listOf(),
    @Json(name = "live_banners") var liveBanners: List<LiveBannerModel>? = listOf(),
    @Json(name = "gender") var gender: String? = "", // or male or null,
    @Json(name = "played_sessions") var playedSessions: List<PlayedSessionDataModel>? = listOf(),
...
data class LiveFrontCoverModel(
    @Json(name = "id") val id: Int? = -1,
...
data class TargetAudienceModel(
    @Json(name = "gender") val gender: String? = "",
